            ...
            <div class="modal-body">
              <form @submit.prevent="isNotValidateForm" name="callback">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="supplier_id" v-model='singleObj.supplier_id'>
                </div>

                <div class="form-group">
                  <label for="quantity_total" class="form-control-label">Required Quantity</label>
                  <input type="text" class="form-control" id="quantity_total" v-model='singleObj.quantity_total'>
                </div>
    ...
    export default {
        ...
        data(){
            return {
                ...
                isAll:"",
                pagination:{},
                singleObj:{product_id:Number,order_id:Number,supplier_id:Number,quantity_total:Number,order_date:Date},
                pupupMod:'add',
                showAdd:false,
                showAlert:false,
                alertType:'',
        ...
        methods:{
            ...
            all(page=1){
                this.resetAlert();
                let uri=`/employee/orders?page=${page}&sort=${this.sortOrder.field}&order=${this.sortOrder.order}`;
            ...
            removeMultiple(){
                this.resetAlert();
                let uri=`/employee/orders/removeBulk`;
            ...
            store(){
                ...
                this.$http.post('/employee/orders',this.singleObj).then((response)=>{
                    let res=response.data;
            ...
            switchStatus(obj){
              ...
              let uri=`/employee/orders/status`;
            ...
            switchStatusSelected(){
              this.resetAlert();
              let uri=`/employee/orders/statusBulk`;
            ...
            searchInput(){
                ...
                let uri=`/employee/orders?searchQuery=${searchQuery}&sort=${this.sortOrder.field}&order=${this.sortOrder.order}`;
                this.$http.get(uri).then((response)=>{
                    let res= response.data;
                    if(res.status_code==200){
                        this.componentData =res.data;
